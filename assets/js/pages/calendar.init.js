!function (g) {
    ...
    var m = new FullCalendar.Calendar(v, {
      ...
      m.render(),
        g(a).on("submit", function (e) {
          ...
          var t,
            a = g("#event-title").val(),
            n = g("#event-category").val(); !1 === s[0].checkValidity() ? (event.preventDefault(),
              event.stopPropagation(), s[0].classList.add("was-validated")) : (i ? (i.setProp("title", a),
                i.setProp("classNames", [n])) : (t = {
                  title: a,
                  start: r.date,
                  allDay: r.allDay,
                  className: n
  ...
  function () {
    "use strict"; window.jQuery.CalendarPage.init()
  }();